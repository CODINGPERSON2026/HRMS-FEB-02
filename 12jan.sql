...
CREATE TABLE `daily_statistics` (
  ...
  `total_auth` bigint DEFAULT '0',
  `total_present` bigint DEFAULT '0',
  `total_absent` bigint DEFAULT '0',
  `offr_auth` int DEFAULT '0',
  `offr_present` int DEFAULT '0',
  `jco_auth` int DEFAULT '0',
  `jco_present` int DEFAULT '0',
  `or_auth` int DEFAULT '0',
  `or_present` int DEFAULT '0',
...
INSERT INTO `department_accounts` VALUES (6,'IT',5000.00,'ACTIVE','2026-01-07 07:20:45','2026-01-07 07:27:45'),(7,'SWSG',10010100.00,'ACTIVE','2026-01-07 07:21:16','2026-01-08 14:18:47'),(8,'ATG',10.00,'ACTIVE','2026-01-07 09:12:43','2026-01-07 09:13:37'),(9,'IT HW',80000.00,'ACTIVE','2026-01-07 09:41:39','2026-01-07 09:44:45'),(10,'abc',222222.00,'ACTIVE','2026-01-11 07:36:33','2026-01-11 07:36:33');
...
CREATE TABLE `export_history` (
  `id` int NOT NULL AUTO_INCREMENT,
  `parade_state_id` int NOT NULL,
  `exported_by` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `export_type` enum('csv','pdf','excel') COLLATE utf8mb4_unicode_ci NOT NULL,
  `export_date` datetime DEFAULT CURRENT_TIMESTAMP,
  `file_size` int DEFAULT NULL,
  `download_count` int DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `parade_state_id` (`parade_state_id`),
  KEY `idx_export_date` (`export_date`),
  KEY `idx_export_type` (`export_type`),
  CONSTRAINT `export_history_ibfk_1` FOREIGN KEY (`parade_state_id`) REFERENCES `parade_state_main` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `family_members` VALUES (1,1,'778G','Spouse','Jane Doe','1987-04-15','987654321098','P-II/2012/003'),(2,2,'156WE','Spouse','Jane Doe','1987-04-15','987654321098','P-II/2012/003'),(3,3,'1526WE','Spouse','Jane Doe','1987-04-15','987654321098','P-II/2012/003'),(4,4,'9926WE','Spouse','Jane Doe','1987-04-15','987654321098','P-II/2012/003'),(5,5,'99226WE','Spouse','Jane Doe','1987-04-15','987654321098','P-II/2012/003'),(6,6,'966WE','Spouse','Jane Doe','1987-04-15','987654321098','P-II/2012/003'),(7,7,'87CESR','Spouse','Jane Doe','1987-04-15','987654321098','P-II/2012/003'),(8,8,'997CESR','Spouse','Jane Doe','1987-04-15','987654321098','P-II/2012/003'),(9,10,'965CESR','Spouse','Jane Doe','1987-04-15','987654321098','P-II/2012/003'),(10,12,'905CESR','Spouse','Jane Doe','1987-04-15','987654321098','P-II/2012/003'),(11,13,'9085CESR','Spouse','Jane Doe','1987-04-15','987654321098','P-II/2012/003'),(12,14,'25CESR','Spouse','Jane Doe','1987-04-15','987654321098','P-II/2012/003'),(13,15,'165CESR','Spouse','Jane Doe','1987-04-15','987654321098','P-II/2012/003'),(14,16,'775CESR','Spouse','Jane Doe','1987-04-15','987654321098','P-II/2012/003'),(15,17,'984CESR','Spouse','Jane Doe','1987-04-15','987654321098','P-II/2012/003'),(16,18,'994CESR','Spouse','Jane Doe','1987-04-15','987654321098','P-II/2012/003'),(17,19,'99999CESR','Spouse','Jane Doe','1987-04-15','987654321098','P-II/2012/003'),(18,25,'123456','Father','Robert Doe','1965-05-01','UID1234','FP2');
...
CREATE TABLE `parade_state_main` (
  ...
  `status` enum('draft','submitted','approved','archived') COLLATE utf8mb4_unicode_ci DEFAULT 'draft',
...
--
-- Dumping data for table `parade_state_main`
--

LOCK TABLES `parade_state_main` WRITE;
/*!40000 ALTER TABLE `parade_state_main` DISABLE KEYS */;
/*!40000 ALTER TABLE `parade_state_main` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `projects` VALUES (1,'COMPUTER LAB','Completed',8900.00,'\"Laptops\"',767,'WE ARE RECIEVED ','2026-01-07 13:23:09','IT','Admin'),(2,'Test','PPP',4500000.00,'\"ABC, XYZ\"',8,'abc','2026-01-08 00:40:13','PTPT','1 company');
...
INSERT INTO `sensitive_marking` VALUES (17,'1526WE','INDICPILINE','2026-01-05 15:21:09'),(18,'9926WE','This person is not hygienic','2026-01-06 12:56:06'),(19,'778G','online gamming','2026-01-07 14:53:03'),(20,'AN10005','test user','2026-01-08 19:59:38');
...
INSERT INTO `units_served` VALUES (1,1,'778G',1,'1st Battalion','2010-05-15','2015-05-15','Platoon Commander'),(2,2,'156WE',1,'1st Battalion','2010-05-15','2015-05-15','Platoon Commander'),(3,3,'1526WE',1,'1st Battalion','2010-05-15','2015-05-15','Platoon Commander'),(4,4,'9926WE',1,'1st Battalion','2010-05-15','2015-05-15','Platoon Commander'),(5,5,'99226WE',1,'1st Battalion','2010-05-15','2015-05-15','Platoon Commander'),(6,6,'966WE',1,'1st Battalion','2010-05-15','2015-05-15','Platoon Commander'),(7,7,'87CESR',1,'1st Battalion','2010-05-15','2015-05-15','Platoon Commander'),(8,8,'997CESR',1,'1st Battalion','2010-05-15','2015-05-15','Platoon Commander'),(9,10,'965CESR',1,'1st Battalion','2010-05-15','2015-05-15','Platoon Commander'),(10,12,'905CESR',1,'1st Battalion','2010-05-15','2015-05-15','Platoon Commander'),(11,13,'9085CESR',1,'1st Battalion','2010-05-15','2015-05-15','Platoon Commander'),(12,14,'25CESR',1,'1st Battalion','2010-05-15','2015-05-15','Platoon Commander'),(13,15,'165CESR',1,'1st Battalion','2010-05-15','2015-05-15','Platoon Commander'),(14,16,'775CESR',1,'1st Battalion','2010-05-15','2015-05-15','Platoon Commander'),(15,17,'984CESR',1,'1st Battalion','2010-05-15','2015-05-15','Platoon Commander'),(16,18,'994CESR',1,'1st Battalion','2010-05-15','2015-05-15','Platoon Commander'),(17,19,'99999CESR',1,'1st Battalion','2010-05-15','2015-05-15','Platoon Commander'),(18,25,'123456',1,'Unit Alpha','2016-07-01','2018-07-01','Training');
...
CREATE TABLE `user_favorites` (
  ...
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_user_favorite` (`user_id`,`parade_state_id`),
  KEY `parade_state_id` (`parade_state_id`),
  KEY `idx_user_id` (`user_id`),
  CONSTRAINT `user_favorites_ibfk_1` FOREIGN KEY (`parade_state_id`) REFERENCES `parade_state_main` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-01-12 15:02:49
